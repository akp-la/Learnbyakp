...
const BASE = "https://apiserver-6hat.onrender.com";
...
function createApp() {
 ...
 app.get("/api/missionjeet/content-details", async (req, res) => {
  try {
    ...
    const url = `https://apiserver-6hat.onrender.com/api/missionjeet/content-details?content_id=${entityId}&course_id=${courseId}`;
...
app.get("/api/vibrant/previous-live", async (req, res) => {
  try {
    ...
    // External API call
    const url = `https://apiserver-6hat.onrender.com/api/vibrant/previous-live?course_id=${courseid}`;
...
//=========uwqeuiweyqi====
 app.get("/api/missionjeet/course-details", async (req, res) => {
  try {
    ...
    // External API call
    const url = `https://apiserver-6hat.onrender.com/api/missionjeet/course-details?courseid=${courseid}`;
...
app.get("/api/missionjeet/all-content/:courseid", async (req, res) => {
  try {
    ...
    let externalUrl;
    if (id && id !== courseid) {
      externalUrl = `https://apiserver-6hat.onrender.com/api/missionjeet/all-content/${courseid}?id=${id}`;
    } else {
      externalUrl = `https://apiserver-6hat.onrender.com/api/missionjeet/all-content/${courseid}`;
    }
  ...
  app.get("/api/batches", async (req, res) => {
    try {
      const r = await fetchfn(
        "https://apiserver-6hat.onrender.com/api/pw/batches"
      );
...
//===============ytryutuytyu======
    ...
    try {
      const r = await fetchfn(
        "https://apiserver-6hat.onrender.com/api/vibrant/batches"
      );
      const data = await r.json();
      res.json(data);
    } catch (e) {
...
//==============
 app.get("/api/vibrant/content", async (req, res) => {
  try {
    ...
    // 🔗 original API
    const url = new URL("https://apiserver-6hat.onrender.com/api/vibrant/content");
...
app.get("/api/vibrant/video-details", async (req, res) => {
  try {
    ...
    const url = new URL("https://apiserver-6hat.onrender.com/api/vibrant/video-details");
    url.searchParams.set("course_id", course_id);
...
app.get("/api/nexttoppers/all-content", async (req, res) => {
  try {
    ...
    const url = new URL("https://apiserver-6hat.onrender.com/api/nexttoppers/all-content");
...
app.all("/api/vibrant/live-file", async (req, res) => {
  ...
  try {
    ...
    const proxyUrl =
      "https://apiserver-6hat.onrender.com/api/vibrant/play?url=" +
  ...
  try {
    ...
    // External API call
    const url = `https://apiserver-6hat.onrender.com/api/nexttoppers/course-details?courseid=${courseid}`;
...
app.get("/api/nexttoppers/content-details", async (req, res) => {
  try {
    ...
    const url = `https://apiserver-6hat.onrender.com/api/nexttoppers/content-details?content_id=${entityId}&courseid=${courseId}`;
...
if (!response.ok) {
  ...
  app.get("/api/nexttoppers/batches", async (req, res) => {
    try {
      const r = await fetchfn(
        "https://apiserver-6hat.onrender.com/api/nexttoppers/batches"
      );
      const data = await r.json();
      res.json(data);
    } catch (e) {
...
// Endpoint for /api/jeet/batches
  app.get("/api/missionjeet/batches", async (req, res) => {
    try {
      const r = await fetchfn(
        "https://apiserver-6hat.onrender.com/api/missionjeet/batches"
      );
      const data = await r.json();
      res.json(data);
    } catch (e) {
...
//=============pw batch details
const UPSTREAM = "https://apiserver-6hat.onrender.com";
